...
for var in variables:
    ...
    print(f"Linear regression on {var}: coefficient for treatment = {coef:.4f}, p-value = {p_val:.4f}")
    print()
...
sns.barplot(
    ...
    palette=['skyblue', 'salmon']  # Customize colors here
)
...
print(regression_model.summary2().tables[1])
```
...
diff_data = p_treatment - p_control
